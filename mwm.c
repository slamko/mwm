...
static const char *amixerup[]  = { "amixerup", NULL };
static const char *amixerdown[]  = { "amixerdown ", NULL };
...
static Key keys[] = {
	...
	{ Mod1Mask,             		XK_Left,   spawn,          {.v = amixerdown } },
	{ Mod1Mask,             		XK_Right, 	   spawn,          {.v = amixerup } },
...
static Fnt *xfont_create(Drw *drw, const char *fontname,
  ...
  /* Do not alloxw using color fonts. This is a workaround for a BadLength
